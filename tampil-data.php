    ...
    <table>
        ...
        ?>
            <tr>
                ...
                <td>
                    <a class="ubah" href="ubah-data.php?idMhs=<?= $row['idMhs']; ?>">✏️ Ubah</a> |
                    <a class="hapus" href="hapus-data.php?idMhs=<?= $row['idMhs']; ?>" onclick="return confirm('Yakin ingin menghapus data ini?')">🗑️ Hapus</a>
                </td>
            </tr>
        <?php endwhile; ?>
    </table>
